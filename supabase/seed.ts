...
const locations = [
  {
    ...
    description: "A decaying asylum in the Victorian highlands, closed in 1964 following multiple 'unexplained' patient disappearances.",
...
async function seed() {
  ...
  // 3. Seed Investigations (Linked to locations)
  const whisperingAsylum = {
    ...
    content: {
      blocks: [
        ...
        { type: 'paragraph', data: { text: 'We established our base of operations in the former admin office at 11:45 PM. Ambient noise was unusually high for an empty structure.' } }
      ]
    },
